...
public class MinimumDepthOfBinaryTree {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // **** convert int[] arr to list ****
        List<Integer> levelOrderValues = Arrays.stream(arr)
                                            //.boxed()
                                            .collect(Collectors.toList());

        // ???? ????
        System.out.println("main <<< levelOrderValues: " + levelOrderValues);


        // // **** populate per level the binary tree ****
        // bt.root = bt.populate(levelOrderValues);

        // // **** populate per level the binary tree using ChatGPT suggestion
        // //      first attempt (fails when it encounters null input values) ****
        // bt.root = bt.populateGPT(levelOrderValues);

        // **** populate per level the binary tree using ChatGPT suggestion
        //      second attempt (seems to work great) ****
        bt.root = bt.populateTreeGPT(levelOrderValues);
